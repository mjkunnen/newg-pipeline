...
async function main() {
  ...
  // Note: scrapePPSpy() does NOT call writeToContentAPI internally (index.ts owns the PPSpy call).
  // TikTok and Pinterest scrapers write to the API themselves (they run as standalone steps).
  await writeToContentAPI(ads, "ppspy");
